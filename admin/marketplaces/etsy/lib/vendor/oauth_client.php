...
class oauth_client_class {
	...
	*/
	...
	{/metadocument}
	*/
	var $configuration_file = CED_UMB_DIRPATH . 'admin/marketplaces/etsy/lib/vendor/oauth_configuration.json';
	...
	*/
	function GetAccessToken( &$access_token ) {
		...
		$ced_etsy_access_token = isset( $access_tokens[ $this->shop_name ] ) ? $access_tokens[ $this->shop_name ] : get_option( 'ced_etsy_access_token', array() );
		if ( ! empty( $ced_etsy_access_token ) ) {
			$access_token = $ced_etsy_access_token[ $access_token_url ];
		} elseif ( isset( $_SESSION['OAUTH_ACCESS_TOKEN'][ $access_token_url ] ) ) {
